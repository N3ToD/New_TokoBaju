    ...
    <section id="new" class="w-100">
        <div class="row p-0 m-0">
            <div class="one col-lg-4 col-md-12 col-12 p-0">
                <img class="img-fluid" src="assets/img/new/1.jpg" alt="New Arrival 1">
                <div class="details">
                    <h2>Kesukaan Mu</h2>
            ...
            <div class="one col-lg-4 col-md-12 col-12 p-0">
                <img class="img-fluid" src="assets/img/new/5.jpg" alt="New Arrival 1">
                <div class="details">
                    <h2>Kesukaan Mu</h2>
                    <button class="text-uppercase">Shop Now</button>
                </div>
            ...
            <div class="one col-lg-4 col-md-12 col-12 p-0">
                <img class="img-fluid" src="assets/img/new/3.jpg" alt="New Arrival 1">
                <div class="details">
